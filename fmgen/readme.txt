...
【概要】
	C++ による FM 音源, PSG 音源の実装例です．
	
	AY8910, YM2203, YM2151, YM2608, YM2610 相当の
	インターフェースもついています．


【使い方】
	各ヘッダファイル(psg.h, opna.h, psg.h)を参照してください．
...
【著作権、免責規定】
	...
	・本ソースコードは作者(cisc@remus.dti.ne.jp) が著作権を所有しています。
	...
	・本ソースコードは，以下の制限を満たす限り自由に改変・組み込み・
	  ...
	  1. 本ソフトの由来(作者, 著作権)を詐称しないこと．
	  2. 配布する際にはフリーソフトとすること．
	  3. 改変したソースコードを配布する際は改変したことを明記すること．
